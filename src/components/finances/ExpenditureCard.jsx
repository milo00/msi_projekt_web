  ...
  return (
    <>
      ...
      >
        ...
        >
          <Typography variant="h5">{expenditureData.title}</Typography>
        </Box>
        <Box
          sx={{
            width: "100%",
        ...
        >
          ...
          <Typography variant="h6" sx={{ color: "text.primary", mr: "3px" }}>
        ...
        <Box sx={{ width: "100%", backgroundColor: "#dee2e6", mt: 2 }}>
          <Typography variant="h6" sx={{ mx: 1, color: "#000000" }}>
            Contributors
          </Typography>
        </Box>
        <Box sx={{ overflow: "auto" }}>
          <TableContainer component={Paper}>
            <Table size="small">
              <TableBody>{allContributors}</TableBody>
            </Table>
          </TableContainer>
        </Box>
      </Dialog>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Typography
                sx={{ fontSize: "22px", color: "text.primary", mr: 2 }}
              >
              ...
              {expenditureData.debtors && (
                ...
                >
                  <Typography
                    sx={{ color: "secondary.main", fontSize: "28px" }}
                  >
                    -
                  </Typography>
          ...
          >
            ...
            >
              <Typography sx={{ fontSize: "24px", color: "primary.main" }}>
                {currencyLoading ? (
                  <CircularProgress size="24px" sx={{ ml: 2, mt: 1 }} />
                ) : (
                  `${expenditureData.cost} ${currency}`
                )}
              </Typography>
