...
export const SelectAttractionDialog = ({
  open,
  onClose,
  attractionData,
  closeWithSelect,
    ...
    <div>
      ...
      >
        ...
        >
          ...
          >
            <Typography variant="h4">Select attraction</Typography>
        ...
        <DialogContent sx={{ pb: 1 }}>
          ...
          <form
            onSubmit={handleSubmit(() =>
              handleAttractionAddition(attractionName, description.value)
            )}
          >
            <TextField
              type="string"
